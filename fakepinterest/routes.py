...
def homepage():
    ...
    if form_login.validate_on_submit():
        ...
        if usuario and bcrypt.check_password_hash(usuario.senha.encode("uft-8"), form_login.senha.data):
...
def criarconta():
    ...
    if form_criar_conta.validate_on_submit():
        senha = bcrypt.generate_password_hash(form_criar_conta.senha.data).decode("uft-8")
